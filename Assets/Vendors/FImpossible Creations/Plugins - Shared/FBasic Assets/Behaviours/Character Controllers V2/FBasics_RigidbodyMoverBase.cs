...
namespace FIMSpace.Basics
{
    ...
    public abstract class FBasics_RigidbodyMoverBase : MonoBehaviour
    {
        ...
        {
            rigbody.linearVelocity = new Vector3(rigbody.linearVelocity.x, 0f, rigbody.linearVelocity.z);
            rigbody.AddForce(Vector3.up * triggerJumping, ForceMode.VelocityChange);
